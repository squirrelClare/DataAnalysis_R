...
viewId<-function(id,wethData,preDate,ahead) {
	...
	preds=holiday_prediction(models,loadData,wethData,preDate,ahead,alpha = .24,beta_1 = .15,beta_2 = .92)
...
test<-function() {
	wethData=read.csv("~/Desktop/南山区_西丽.csv",header=T)
	sql<-'select VKONT from xili_ids;'
	ids<-unlist(holiday_exeDm2015(sql))

	preDates<-c('2013-10-1','2013-10-4','2014-1-1','2014-1-31','2014-2-3','2014-4-5','2014-5-1','2014-6-2','2014-9-8')
	aheads<-c(3,4,3,3,4,3,3,3,1)
	tNames<-c('holiday_20131001_1003','holiday_20131004_1007','holiday_20140101_0103','holiday_20140131_0202','holiday_20140203_0206',
		'holiday_20140405_0407','holiday_20140501_0503','holiday_20140602_0605','holiday_20140908')
